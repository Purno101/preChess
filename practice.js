...
function onPlayerMove(moveStr) {
    ...
    console.log("Player move:", moveStr, "Expected:", expectedMove);
...
function computerMove() {
    ...
    console.log("Computer move:", moveStr);

    // Save snapshot BEFORE applying computer move? The code previously saved after applying; keep consistent:
